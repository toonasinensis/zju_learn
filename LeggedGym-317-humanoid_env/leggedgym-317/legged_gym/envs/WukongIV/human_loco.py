...
from legged_gym.envs.WukongIV.wk4_loco_config import HumanLocoCfg


class HumanLocoEnv(BaseTask):
    def __init__(self, cfg: HumanLocoCfg, sim_params, physics_engine, sim_device, headless):
    ...
    def reset_idx(self, env_ids):
        ...
        if self.cfg.terrain.measure_heights:
            self.measured_heights = self._get_heightmap()
        # fill extras
        self.extras["episode"] = {}
    ...
    def compute_observations(self):
        ...
        self.privileged_obs_buf = torch.cat(
            (self.obs_buf, self.base_height_buf, self.foot_heightmap_buf), dim=-1)
    ...
    def create_sim(self):
        ...
        if mesh_type in ['heightfield', 'trimesh']:
            ...
            self.terrain.has_depth_sensor = False
        if mesh_type == 'plane':
    ...
    def _resample_commands(self, env_ids):
        ...
        # abc = torch_rand_float(1,1,(1, 1),device=self.device).squeeze(1)
        

        # print("self.avb",abc)
        # print(self.command_ranges["lin_vel_x"][0])
        # print(self.command_ranges["lin_vel_x"][1])
        ...
        shall_stop_index = env_ids[zero_cmd_dec]
        self.commands[shall_stop_index, :] = 0
    ...
    def _create_trimesh(self):
        ...
        tm_params.transform.p.x = -self.terrain.cfg.border_length
    ...
    def _get_heightmap(self, env_ids=None):
    ...
    #     stance_mask[torch.abs(sin_pos) < 0.1] = 1#TODO: adjust this can set double support time
